...
export default {
  ...
  created: function () {
    ...
    .then(response => {
      ...
      this.markers.push({position: {lng: this.trees[i].coordinates.longitude, lat: this.trees[i].coordinates.latitude}}, icon: {url:'https://imageshack.com/a/img922/879/deEdYF.png'})
    }
    })
    .catch(e => {
      this.errorTree = e;

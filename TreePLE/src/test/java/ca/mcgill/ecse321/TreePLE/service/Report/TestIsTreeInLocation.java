...
public class TestIsTreeInLocation {
	...
	public void testPrecision() throws InvalidInputException {
		...
		assertEquals(false, rs.isTreeInLocation(4.10653346,4.66328298,perimeter));
		assertEquals(false, rs.isTreeInLocation(0.9088760,0.0653346,perimeter));
		assertEquals(false, rs.isTreeInLocation(0.9088760,4.66328298,perimeter));
		assertEquals(false, rs.isTreeInLocation(4.10653346,0.0653346,perimeter));
		assertEquals(false, rs.isTreeInLocation(0,0,perimeter));
